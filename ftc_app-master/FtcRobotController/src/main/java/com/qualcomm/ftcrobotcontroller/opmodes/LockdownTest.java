 ...
 */
public class LockdownTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //Start of Autonomous
        waitForStart();
        waitForInches(motorLeft, motorRight, 10, 0.5);
    ...
    public void waitForInches(DcMotor motorLeft, DcMotor motorRight, int inches, double power) throws InterruptedException {
        {
            ...
            while(true)
            {
                if(((leftMotorTarget - getMotorPosition(motorLeft)) < 50) && ((rightMotorTarget - getMotorPosition(motorRight)) < 50))
                {
                    break;
                }
                ...
                if(getMotorPosition(motorRight) < getMotorPosition(motorLeft))
                {
                    power += 0.1;
                    Range.clip(power, -1, 1);
